...
class User(object):
    ...
    def _load_properties(self):
        ...
        if int(person.iconserver) > 0:
            self.__icon_url = 'https://photos%s.flickr.com/buddyicons/%s.jpg' \
                              % (person.iconserver, self.__id)
        else:
            self.__icon_url = 'https://www.flickr.com/images/buddyicon.jpg'
...
#Flickr API methods
#see api docs https://www.flickr.com/services/api/
